(function attachSiteContent() {
  ...
  const cards = [
    {
      ...
      description: "썸과 연애에서 내가 어떤 속도로 마음을 움직이는지 알아보는 대표 연애 테스트입니다.",
      ...
      featuredLabel: "대표 연애 테스트",
      featuredHook: "썸이 시작되면 나는 직진할까, 천천히 리듬을 맞출까?",
      featuredReason: "가장 공유가 잘 붙는 쿠쿠 대표 연애 카드"
    },
    {
      id: "test-002",
      title: "직장인 회복력 체크",
    ...
    },
    {
      id: "test-005",
      title: "친구 케미 점수 보기",
      description: "친구 사이에서 내가 어떤 분위기를 만드는지 바로 비교해보기 좋은 관계 테스트입니다.",
      ...
      featuredLabel: "친구랑 하기 좋은 테스트",
      featuredHook: "같이 해보면 왜 잘 맞는지, 왜 엇갈리는지 더 또렷하게 보여요.",
      featuredReason: "단톡방에 던지기 좋은 관계형 카드"
    },
    {
      id: "test-006",
      title: "주말 충전 방식 찾기",
  ...
  const pages = {
    "test-001": createPage({
      ...
      shareDescription: "썸이 시작되면 나는 직진할까, 천천히 리듬을 맞출까? 쿠쿠 대표 연애 테스트로 바로 확인해보세요.",
      shareSectionTitle: "친구에게 보내면 더 재밌어요",
      sharePrompt: "친구에게 결과를 보내고, 누가 더 빠르게 달리고 누가 더 천천히 맞추는 타입인지 비교해보세요.",
      heroArt: {
        centerEmoji: "🚂",
        stickers: ["💌", "🎟️", "🌼", "☁️", "💗", "🫧", "⭐", "🌙"]
      },
    ...
    "test-005": createPage({
      ...
      shareDescription: "친구 사이에서 나는 분위기 메이커일까, 공감형일까? 같이 해보면 더 재밌는 관계 테스트예요.",
      shareSectionTitle: "같이 해보면 더 잘 보여요",
      sharePrompt: "친구에게 보내고 서로 어떤 역할을 맡는지 비교해보세요. 단톡방에 던지기 좋은 테스트예요.",
      ...
      results: {
        manager: { title: "든든한 총무형", summary: "모임의 흐름과 실무를 은근히 책임지는 타입", shareTitle: "내 친구 케미 결과는 든든한 총무형", shareDescription: "약속과 흐름을 정리하고 판을 굴리는 역할이 자연스러운 타입이에요. 친구들이 믿고 기대는 포지션에 가깝습니다.", description: "당신은 친구 관계에서도 자연스럽게 판을 정리하는 역할을 맡는 편입니다. 일정, 준비물, 흐름을 맞추는 데 강점이 있어 주변에서 믿고 기대는 사람이 되기 쉽습니다.", strengths: ["정리와 조율에 강함", "사람들이 편하게 움직이게 만듦", "믿고 맡길 수 있는 안정감"], tip: "책임지는 역할이 익숙해도, 가끔은 남이 정한 흐름에 편하게 올라타는 시간도 필요해요.", moodTitle: "찰떡 친구 무드", moodItems: ["계획 여행", "역할 분담", "단체 일정 조율"], matchTitle: "잘 맞는 조합", matchLabel: "분위기 메이커형", matchDescription: "당신의 정리력과 상대의 생동감이 만나면 모임이 가장 안정적이면서도 재밌어집니다.", heroEmoji: "📋" },
        listener: { title: "다정한 공감형", summary: "친구 마음을 잘 읽고 정서적 쿠션이 되는 타입", shareTitle: "내 친구 케미 결과는 다정한 공감형", shareDescription: "친구가 지쳤는지 서운한지 먼저 알아채고 편안한 대화를 만들어주는 타입이에요. 관계를 오래가게 하는 힘이 큽니다.", description: "당신은 무리 속에서도 누가 지쳤는지, 누가 서운한지 빠르게 느끼는 편입니다. 조용히 들어주고 진심으로 반응해주는 힘이 커서 관계를 오래가게 만드는 역할을 합니다.", strengths: ["친구의 감정 변화를 잘 읽음", "깊은 대화를 편안하게 만듦", "관계를 오래 유지하는 안정감"], tip: "공감도 좋지만 내 기분도 같이 표현해야 관계가 더 건강하게 오래 갑니다.", moodTitle: "찰떡 친구 무드", moodItems: ["산책 수다", "심야 통화", "조용한 카페"], matchTitle: "잘 맞는 조합", matchLabel: "자유로운 즉흥형", matchDescription: "상대의 가벼움이 당신의 부담을 덜고, 당신의 다정함이 관계를 깊게 만들어줍니다.", heroEmoji: "💗" },
        spark: { title: "분위기 메이커형", summary: "친구 사이 공기를 환하게 바꾸는 타입", shareTitle: "내 친구 케미 결과는 분위기 메이커형", shareDescription: "함께 있으면 분위기를 살리고 어색함을 줄여주는 타입이에요. 단톡방과 모임에서 존재감이 큰 편입니다.", description: "당신은 함께 있을 때 분위기를 띄우고, 어색함을 줄이는 데 강점이 있습니다. 무거워질 수 있는 순간에도 자연스럽게 유쾌한 흐름을 만들며 모임의 온도를 올립니다.", strengths: ["사람들을 웃게 만드는 힘", "어색한 순간을 풀어내는 감각", "함께 있으면 기억이 선명해짐"], tip: "즐거움이 강점인 만큼, 가끔은 진지한 마음도 함께 보여주면 더 깊은 신뢰가 생깁니다.", moodTitle: "찰떡 친구 무드", moodItems: ["즉흥 번개", "놀이형 모임", "짧은 여행"], matchTitle: "잘 맞는 조합", matchLabel: "든든한 총무형", matchDescription: "상대가 흐름을 잡아주면 당신의 에너지가 훨씬 편하게 빛날 수 있습니다.", heroEmoji: "🎉" },
        free: { title: "자유로운 즉흥형", summary: "편하고 자연스러운 흐름 속에서 케미가 살아나는 타입", shareTitle: "내 친구 케미 결과는 자유로운 즉흥형", shareDescription: "빽빽한 규칙보다 편안한 흐름 속에서 케미가 살아나는 타입이에요. 부담 없는 약속일수록 당신의 매력이 커집니다.", description: "당신은 규칙보다 편안함과 자연스러운 호흡을 중요하게 생각합니다. 즉흥적인 제안에도 잘 반응하고, 너무 빡빡한 관계보다 부담 없는 케미에서 만족도가 높습니다.", strengths: ["유연하고 편안한 분위기", "즉흥 상황에 대한 적응력", "친구를 부담 없이 이어주는 감각"], tip: "자유로움이 강점이라도, 중요한 약속 한두 가지는 더 선명하게 챙기면 신뢰가 더 커집니다.", moodTitle: "찰떡 친구 무드", moodItems: ["당일 약속", "드라이브", "동네 산책"], matchTitle: "잘 맞는 조합", matchLabel: "다정한 공감형", matchDescription: "상대의 세심함이 당신의 자유로움을 더 편안하게 지켜주고, 당신은 관계에 숨통을 틔워줍니다.", heroEmoji: "🌈" }
      },
      resultPreview: ["든든한 총무형", "다정한 공감형", "분위기 메이커형", "자유로운 즉흥형"],
      relatedIds: ["test-001", "test-003", "test-006"],
      callout: "친구에게 결과를 보내고 서로 역할을 비교해보면, 왜 누가 총무가 되고 누가 분위기를 살리는지 더 또렷하게 보여요."
    }),
    "test-006": createPage({
      category: "라이프",
      title: "주말 충전 방식 찾기",
